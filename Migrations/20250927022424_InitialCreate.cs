    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 2, "Lima", "DEP001", "Av. Larco 123", 2, null, 80, 150000m, 0, "Depa Miraflores" },
                    { 2, true, 2, "Arequipa", "CAS001", "Calle Real 456", 3, null, 120, 250000m, 1, "Casa Arequipa" },
                    { 3, true, 1, "Lima", "OFC001", "Av. Javier Prado 789", 0, null, 60, 180000m, 2, "Oficina San Isidro" }
                });
